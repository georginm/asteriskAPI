...
class CreateTransportValidator {
  constructor(protected ctx: HttpContextContract) {}

  public schema = schema.create({
    id: schema.string({ trim: true }, [rules.maxLength(40)]),
    bind: schema.string({ trim: true }, [rules.maxLength(40)]),
    protocol: schema.enum(['udp', 'tcp', 'tls', 'ws', 'wss', 'flow']),
...
export { CreateTransportValidator }
